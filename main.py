...
thresh = color_sobel_threshold(undistorted, 3, cv2.COLOR_RGB2HLS, fancy = True,
...
persp = perspective(PLL, PUL, PUR, PLR, PERSPECTIVE_OFFSET, thresh)
...
class lane_detector:
    ...
    STATE_LAST_FRAME_USABLE = 1 # continue using polynomial+epsilon for searching lane instead of boxes
...
mpimg.imsave("fancy/warped.jpg", warped)
